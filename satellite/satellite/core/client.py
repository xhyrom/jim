...
class CoreClient:
    ...
    def __init__(self, base_url: str = "http://localhost:31415", api_key: Optional[str] = None):
    ...
    async def ask(self, text: str, user_id: str = "default", device_id: str = "satellite") -> Dict[str, Any]:
